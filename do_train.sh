...
CUDA_VISIBLE_DEVICES=2 python train/train.py -c conf/exp/srn.conf -D /root/dataset2/ShapeNet/cars --lr 1e-4 --recon 50 --name cycle-app-check-delete --cam 10 --disc_lr 0.01 --batch_size 4